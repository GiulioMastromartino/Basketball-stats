...
Revision ID: 012_add_games_schema_version
Revises: 011_add_workos_fields
...
revision = '012_add_games_schema_version'
down_revision = '011_add_workos_fields'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # Check if games table exists and column is missing
