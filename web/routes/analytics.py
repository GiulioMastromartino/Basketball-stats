...
# Continue with rest of the file (team_report_pdf, player_report_pdf, download_all_reports and helper functions)...
# [Implementation continues with working versions from feature/docker-support]
